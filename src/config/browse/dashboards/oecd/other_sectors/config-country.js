            ...
            items: [
                ...
                },
                {
                    ...
                    filterFor: {
                       ...
                       // "filter_total_sector_country_oda": ['fao_region_code', 'recipientcode', 'parentsector_code', 'year', 'oda']
                ...
                },
                {
                    ...
                    filterFor: {
                        // "filter_total_country_sector_oda": ['fao_region_code', 'recipientcode',  'parentsector_code', 'year', 'oda'],
                        // "filter_total_country_subsector_oda": ['fao_region_code', 'recipientcode',  'parentsector_code', 'purposecode', 'year', 'oda']
                ...
                },
                {
                    ...
                    filterFor: {
                        // "filter_donor": ['fao_region_code', 'recipientcode', 'parentsector_code', 'purposecode', 'year', 'oda']
                ...
                },
                {
                    ...
                    filterFor: {
                        //"filter_top_10_donors_sum": ['fao_region_code', 'recipientcode', 'parentsector_code', 'purposecode', 'year', 'oda'],
                        //"filter_top_all_donors_sum": ['fao_region_code', 'recipientcode', 'parentsector_code', 'purposecode', 'year', 'oda']
                        "filter_top_10_donors_sum": ['recipientcode', 'parentsector_code', 'purposecode', 'year', 'oda'],
                        "filter_top_all_donors_sum": ['recipientcode', 'parentsector_code', 'purposecode', 'year', 'oda']
                    },
                ...
                },
                {
                    ...
                    // filterFor: ['fao_region_code', 'recipientcode', 'parentsector_code', 'purposecode', 'year', 'oda'],
                ...
                },
                {
                    ...
                    filterFor: {
                        // "filter_sectors": ['fao_region_code', 'recipientcode', parentsector_code', 'year', 'oda']
