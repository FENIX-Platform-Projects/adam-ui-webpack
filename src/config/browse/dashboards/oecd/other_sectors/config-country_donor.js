            ...
            items: [
                {
                    ...
                    filterFor: {
                        // "filter_total_ODA": ['fao_region_code', 'recipientcode', 'donorcode', 'year', 'oda']
                ...
                },
                {
                    ...
                    filterFor: {
                       // "filter_total_donor_recipient_oda": ['donorcode', 'fao_region_code', 'recipientcode', 'year', 'oda'],
                       // "filter_total_donor_recipient_sector_oda": ['donorcode', 'fao_region_code', 'recipientcode', 'parentsector_code', 'year', 'oda'],

                       // "filter_total_oda_dac_members_by_year": ['parentsector_code', 'year', 'oda'],
                       // "filter_dac_members_by_donor_year": ['fao_region_code', 'recipientcode', 'parentsector_code', 'year', 'oda']
                ...
                },
                {
                    ...
                    filterFor: {
                       // "filter_total_donor_recipient_subsector_oda": ['donorcode',  'fao_region_code', 'recipientcode', 'parentsector_code', 'purposecode', 'year', 'oda'],
                       // "filter_total_donor_recipient_sector_oda": ['donorcode', 'fao_region_code', 'recipientcode', 'parentsector_code', 'year', 'oda'],

                       // "filter_total_oda_dac_members_by_year": ['parentsector_code', 'year', 'oda'],
                       // "filter_dac_members_by_donor_year": ['fao_region_code', 'recipientcode', 'parentsector_code', 'purposecode', 'year', 'oda']
                ...
                },
                {
                    ...
                    // filterFor: ['donorcode', 'fao_region_code', 'recipientcode', 'parentsector_code', 'purposecode', 'year', 'oda'],
                ...
                },
                {
                    ...
                    filterFor: {
                        // "filter_top_10_sectors": [ 'fao_region_code', 'recipientcode', 'donorcode', 'year', 'oda']
                ...
                },
                {
                    ...
                    filterFor: {
                       // "filter_top_10_sectors_sum": ['fao_region_code', 'recipientcode', 'donorcode', 'year', 'oda'],
                      // "filter_all_sectors_sum": ['fao_region_code', 'recipientcode', 'donorcode', 'year', 'oda']
                ...
                },
                {
                    ...
                    filterFor: {
                       // "filter_top_10_subsectors": ['fao_region_code', 'recipientcode', 'parentsector_code', 'donorcode', 'year', 'oda']
