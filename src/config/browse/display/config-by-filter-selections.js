    ...
    return {
        "sector": {
            ...
            parentsector_code: [
                ...
                {
                    value: "all",
                    config: { path: "config-all-sectors-sector"},
                    ...
                    show: ['tot-oda', 'top-sectors', 'top-recipients-all-sectors', 'top-partners-all-sectors', 'top-channels-all-sectors', 'top-subsectors']
                },
                {
                    value: "9999",
